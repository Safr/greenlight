...
import (
	...
	_ "github.com/lib/pq"
	"github.com/safr/greenlight/internal/data"
	"github.com/safr/greenlight/internal/jsonlog"
	"github.com/safr/greenlight/internal/mailer"
	"github.com/safr/greenlight/internal/vcs"
)
...
func main() {
	...
	// Use the value of the mailtrap environment variables
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.safr.net>", "SMTP sender")
